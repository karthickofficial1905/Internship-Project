...
urlpatterns = [
    ...
    path('get-review-monthly-data/', views.get_review_monthly_data, name='get_review_monthly_data'),
    ...
    path('reply-support-ticket/<str:ticket_id>/', views.reply_support_ticket, name='reply_support_ticket'),
    path('support/', views.customer_support_center, name='customer_support_center'),
    path('support/create/', views.create_support_ticket, name='create_support_ticket'),
    path('support/ticket/<str:ticket_id>/', views.get_ticket_details, name='get_ticket_details'),
    path('support/reply/<str:ticket_id>/', views.user_reply_ticket, name='user_reply_ticket'),
    path('emp-support/', views.emp_support, name='emp_support'),
    path('employee-reply-ticket/<str:ticket_id>/', views.employee_reply_ticket, name='employee_reply_ticket'),
]
