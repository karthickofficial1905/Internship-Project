...
urlpatterns = [
    ...
    path('user-profiles/create/', views.user_profile_create, name='user_profile_create'),
    path('user-profiles/<int:user_id>/', views.user_profile_detail, name='user_profile_detail'),
    path('user-profiles/<int:user_id>/edit/', views.user_profile_edit, name='user_profile_edit'),
    path('user-profiles/<int:user_id>/delete/', views.user_profile_delete, name='user_profile_delete'),
